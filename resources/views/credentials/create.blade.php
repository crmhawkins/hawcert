    ...
    <form action="{{ route('credentials.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
                ...
                <input type="text" name="website_name" id="website_name" required value="{{ old('website_name') }}" placeholder="Ej: IONOS" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="text" name="username_field_selector" id="username_field_selector" required value="{{ old('username_field_selector') }}" placeholder="Ej: #username, input[name='email']" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="text" name="password_field_selector" id="password_field_selector" required value="{{ old('password_field_selector') }}" placeholder="Ej: #password, input[type='password']" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>

            <div>
                <label for="username" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Usuario</label>
                <input type="text" name="username" id="username" required value="{{ old('username') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>

            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Contraseña</label>
                <input type="password" name="password" id="password" required value="{{ old('password') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
