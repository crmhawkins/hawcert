...
<div class="px-4 sm:px-0">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
            ...
            <div>
                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Selector Campo Usuario</dt>
                <dd class="mt-1 text-sm text-gray-900 dark:text-white font-mono">{{ $credential->username_field_selector }}</dd>
            </div>

            <div>
                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Selector Campo Contraseña</dt>
                <dd class="mt-1 text-sm text-gray-900 dark:text-white font-mono">{{ $credential->password_field_selector }}</dd>
            </div>
